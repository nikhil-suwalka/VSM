...
class CardRow extends StatelessWidget {
  ...
  final cardType= new Container(
    ...
    child: Column(children: <Widget>[Padding(padding: EdgeInsets.only(top: 5),child:Text(name,style: TextStyle(fontSize: 18,color: Colors.white,shadows: <Shadow>[
      ...
      Container(child: Padding(padding: EdgeInsets.only(left: 60,top:2,bottom: 5,right: 20),child: Text(description,textAlign: TextAlign.justify,style: TextStyle(fontSize: 12.5,color: Colors.white,),),),)
    ]));
